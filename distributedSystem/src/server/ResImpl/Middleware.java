...
public class Middleware implements ResourceManager  {
    ...
    static int activeRMCounter;
    
	public static int getNumberofActiveRMs(){
		return activeRMCounter;
	}
	...
	public static void main(String args[]) {
	 ...
	 try 
		 ...
		 Registry registry = LocateRegistry.getRegistry(1990);
		 registry.rebind("30ResourceManager", rm);
